...
numero_decimal = random.randint(1, 100)  # Genera un número decimal aleatorio entre 1 y 100
numero_binario = bin(numero_decimal)[2:]  # Convierte el número decimal a binario y elimina el prefijo '0b'

intentos = 0  # Inicializa el contador de intentos
intentos_maximos = 3  # Establece el número máximo de intentos permitidos
...
if intentos == intentos_maximos:
     ...
     numero_decimal_2 = random.randint(1, 100)  # Genera un nuevo número decimal aleatorio entre 1 y 100
